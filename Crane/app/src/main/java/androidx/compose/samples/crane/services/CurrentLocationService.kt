package androidx.compose.samples.crane.services
...
import androidx.compose.samples.crane.util.SharedPreferenceUtil
import androidx.compose.samples.crane.util.toText
...
class CurrentLocationService: Service() {
    ...
    private fun generateNotification(location: Location?) : Notification {
      val mainNotificationText = location?.toText() ?: getString(androidx.compose.samples.crane.R.string.no_location_text)
       val titleText = getString(androidx.compose.samples.crane.R.string.app_name)
       ...
       return notificationCompatBuilder.setStyle(bigTextStyle)
           ...
           .addAction(
               R.drawable.ic_launch, getString(androidx.compose.samples.crane.R.string.launch_activity),
               activityPendingIntent
           )
           .addAction(
               R.drawable.ic_cancel, getString(androidx.compose.samples.crane.R.string.stop_location_updates_button_text), servicePendingIntent
           )
           .build()
   }
